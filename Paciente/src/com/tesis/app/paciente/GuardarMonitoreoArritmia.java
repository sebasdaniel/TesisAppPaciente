...
public class GuardarMonitoreoArritmia extends AsyncTask<String, Void, Void>{
...
//		request.addProperty("valor", params[0]);
//		request.addProperty("unidades", "latidos/s");
//		request.addProperty("fecha", params[1]);
//		request.addProperty("hora", params[2]);
	...
	protected void onPostExecute(Void result) {
		...
		.setMessage("Su resultado fue " + resultado + " ppm\n\n" + tip)
