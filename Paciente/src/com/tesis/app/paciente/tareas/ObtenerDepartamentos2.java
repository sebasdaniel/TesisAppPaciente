...
public class ObtenerDepartamentos2 extends AsyncTask<Void, Void, Void> {
	
	private String resultado;
	private ConfiguracionActivity mActivity;
	private ArrayList<RegistroDepartamento> registro;
	
	public void setParams(ConfiguracionActivity activity){
		mActivity = activity;
	}
