...
public class GuardarMonitoreoGlucosa extends AsyncTask<String, Void, Void> {
	...
	protected Void doInBackground(String... params) {
		...
		request.addProperty("tipo", "glucosa");
		request.addProperty("descripcion", params[0]);
		request.addProperty("valor", params[1]);
		request.addProperty("unidades", "mg/dL");
		request.addProperty("fecha", params[2]);
		request.addProperty("hora", params[3]);
		request.addProperty("latitud", params[4]);
		request.addProperty("longitud", params[5]);
